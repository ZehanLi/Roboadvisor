...
7.Set the environment variable for AlphaVantage key
    export ALPHA_VANTAGE_KEY='62VU0Z7IKBLN5VYE'
8.Set the environment variable for news-api key (You WILL need this key if you want to view the full functionality of the app!)
    export NEWS_API_KEY='82cfeff574a349b789025b6370f63369'
9.Download and install sqlite3 from https://www.sqlite.org/index.html

# If you want to create your own tables then execute steps 10-11
...
(YOU MAY NEED TO CREATE A FOLDER CALLED "model" under folder RoboAdvisor/model)

# If you want to use our toy datasets then execute steps 12-13
12. cp data/db/trading-mini.db data/db/trading.db
13. cp data/db/Fundamental_Data-mini.db data/db/Fundamental_Data.db
